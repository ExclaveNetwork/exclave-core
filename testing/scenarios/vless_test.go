...
import (
	...
	transtcp "github.com/exclavenetwork/exclave-core/v5/transport/internet/tcp"
		...
		Inbound: []*core.InboundHandlerConfig{
			{
				...
				ProxySettings: serial.ToTypedMessage(&inbound.Config{
					...
					Decryption: "mlkem768x25519plus.native.10-20s.100-111-1111.75-0-111.50-0-3333.QEA3v0l-d6oG6yuRcPVXD5v8YSbwWYhgmpnvvIoD2lE.jhrnUaNY1AOx9ebJY2QfxQ0Z_JakrcAG7_OVCaNC_me2Tu4v2qyFQDuRJ3C1HrPd7W1WvwEvPvq3r13jQMdK5w",
				}),
			},
		},
		Outbound: []*core.OutboundHandlerConfig{
