...
type ServerConfig struct {
	...
	Version       uint32                 `protobuf:"varint,4,opt,name=version,proto3" json:"version,omitempty"`
	UserKey       string                 `protobuf:"bytes,5,opt,name=user_key,json=userKey,proto3" json:"user_key,omitempty"`
	ObfsMode      string                 `protobuf:"bytes,6,opt,name=obfs_mode,json=obfsMode,proto3" json:"obfs_mode,omitempty"`
	ObfsHost      string                 `protobuf:"bytes,7,opt,name=obfs_host,json=obfsHost,proto3" json:"obfs_host,omitempty"`
	ObfsUri       string                 `protobuf:"bytes,8,opt,name=obfs_uri,json=obfsUri,proto3" json:"obfs_uri,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerConfig) GetUserKey() string {
	if x != nil {
		return x.UserKey
	}
	return ""
...
func (x *ServerConfig) GetObfsMode() string {
	if x != nil {
		return x.ObfsMode
	}
	return ""
...
func (x *ServerConfig) GetObfsHost() string {
	if x != nil {
		return x.ObfsHost
	}
	return ""
...
func (x *ServerConfig) GetObfsUri() string {
	if x != nil {
		return x.ObfsUri
	}
	return ""
...
const file_proxy_snell_config_proto_rawDesc = "" +
	...
	"\boutbound\x12\x05snell\"\x93\x02\n" +
	"\fServerConfig\x12=\n" +
	"\aaddress\x18\x01 \x01(\v2#.exclave.core.common.net.IPOrDomainR\aaddress\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03psk\x18\x03 \x01(\tR\x03psk\x12\x18\n" +
	...
	"\tobfs_mode\x18\x06 \x01(\tR\bobfsMode\x12\x1b\n" +
	"\tobfs_host\x18\a \x01(\tR\bobfsHost\x12\x19\n" +
	"\bobfs_uri\x18\b \x01(\tR\aobfsUri:\x14\x82\xb5\x18\x10\n" +
	"\ainbound\x12\x05snellB\x88\x01\n" +
...
var file_proxy_snell_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proxy_snell_config_proto_goTypes = []any{
	...
	(*ServerConfig)(nil),             // 2: exclave.core.proxy.snell.ServerConfig
	(*net.IPOrDomain)(nil),           // 3: exclave.core.common.net.IPOrDomain
}
var file_proxy_snell_config_proto_depIdxs = []int32{
	3, // 0: exclave.core.proxy.snell.ClientConfig.address:type_name -> exclave.core.common.net.IPOrDomain
	0, // 1: exclave.core.proxy.snell.ClientConfig.domain_strategy:type_name -> exclave.core.proxy.snell.ClientConfig.DomainStrategy
	3, // 2: exclave.core.proxy.snell.ServerConfig.address:type_name -> exclave.core.common.net.IPOrDomain
