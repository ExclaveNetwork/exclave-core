...
const file_proxy_vmess_outbound_config_proto_rawDesc = "" +
	"\n" +
	"!proxy/vmess/outbound/config.proto\x12!exclave.core.proxy.vmess.outbound\x1a!common/protocol/server_spec.proto\x1a\x18common/net/address.proto\x1a common/protoext/extensions.proto\x1a\"common/net/packetaddr/config.proto\"\xa8\x01\n" +
	"\x06Config\x12H\n" +
	"\bReceiver\x18\x01 \x03(\v2,.exclave.core.common.protocol.ServerEndpointR\bReceiver\x12T\n" +
	"\x0fpacket_encoding\x18\x02 \x01(\x0e2+.exclave.core.net.packetaddr.PacketAddrTypeR\x0epacketEncoding\"\xe6\x01\n" +
	...
	"\x0fpacket_encoding\x18\x04 \x01(\x0e2+.exclave.core.net.packetaddr.PacketAddrTypeR\x0epacketEncoding:\x15\x82\xb5\x18\x11\n" +
	"\boutbound\x12\x05vmessB\xa3\x01\n" +
	";com.github.exclavenetwork.exclave.core.proxy.vmess.outboundP\x01Z>github.com/exclavenetwork/exclave-core/v5/proxy/vmess/outbound\xaa\x02!Exclave.Core.Proxy.Vmess.Outboundb\x06proto3"
...
var file_proxy_vmess_outbound_config_proto_goTypes = []any{
	(*Config)(nil),                  // 0: exclave.core.proxy.vmess.outbound.Config
	(*SimplifiedConfig)(nil),        // 1: exclave.core.proxy.vmess.outbound.SimplifiedConfig
...
var file_proxy_vmess_outbound_config_proto_depIdxs = []int32{
	2, // 0: exclave.core.proxy.vmess.outbound.Config.Receiver:type_name -> exclave.core.common.protocol.ServerEndpoint
	3, // 1: exclave.core.proxy.vmess.outbound.Config.packet_encoding:type_name -> exclave.core.net.packetaddr.PacketAddrType
	4, // 2: exclave.core.proxy.vmess.outbound.SimplifiedConfig.address:type_name -> exclave.core.common.net.IPOrDomain
	3, // 3: exclave.core.proxy.vmess.outbound.SimplifiedConfig.packet_encoding:type_name -> exclave.core.net.packetaddr.PacketAddrType
