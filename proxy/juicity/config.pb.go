...
// 	protoc        v3.21.12
// source: proxy/juicity/config.proto
...
func (x *ServerConfig) Reset() {
	*x = ServerConfig{}
	mi := &file_proxy_juicity_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ServerConfig) Descriptor() ([]byte, []int) {
	return file_proxy_juicity_config_proto_rawDescGZIP(), []int{1}
}
...
const file_proxy_juicity_config_proto_rawDesc = "" +
	...
	"\boutbound\x12\ajuicity\"\xa9\x01\n" +
	"\fServerConfig\x12=\n" +
	"\aaddress\x18\x01 \x01(\v2#.exclave.core.common.net.IPOrDomainR\aaddress\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x12\n" +
	"\x04uuid\x18\x03 \x01(\tR\x04uuid\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword:\x16\x82\xb5\x18\x12\n" +
	"\ainbound\x12\ajuicityB\x8e\x01\n" +
...
var file_proxy_juicity_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proxy_juicity_config_proto_goTypes = []any{
	(*ClientConfig)(nil),   // 0: exclave.core.proxy.juicity.ClientConfig
	(*ServerConfig)(nil),   // 1: exclave.core.proxy.juicity.ServerConfig
	(*net.IPOrDomain)(nil), // 2: exclave.core.common.net.IPOrDomain
}
var file_proxy_juicity_config_proto_depIdxs = []int32{
	2, // 0: exclave.core.proxy.juicity.ClientConfig.address:type_name -> exclave.core.common.net.IPOrDomain
	2, // 1: exclave.core.proxy.juicity.ServerConfig.address:type_name -> exclave.core.common.net.IPOrDomain
