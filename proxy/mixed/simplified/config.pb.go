...
func (x *ServerConfig) Reset() {
	*x = ServerConfig{}
	mi := &file_proxy_mixed_simplified_config_proto_msgTypes[0]
...
func (*ServerConfig) Descriptor() ([]byte, []int) {
	return file_proxy_mixed_simplified_config_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_proxy_mixed_simplified_config_proto_rawDescOnce sync.Once
	file_proxy_mixed_simplified_config_proto_rawDescData []byte
)

func file_proxy_mixed_simplified_config_proto_rawDescGZIP() []byte {
	file_proxy_mixed_simplified_config_proto_rawDescOnce.Do(func() {
		file_proxy_mixed_simplified_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proxy_mixed_simplified_config_proto_rawDesc), len(file_proxy_mixed_simplified_config_proto_rawDesc)))
	})
	return file_proxy_mixed_simplified_config_proto_rawDescData
}
...
func file_proxy_mixed_simplified_config_proto_init() {
	if File_proxy_mixed_simplified_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proxy_mixed_simplified_config_proto_rawDesc), len(file_proxy_mixed_simplified_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proxy_mixed_simplified_config_proto_goTypes,
		DependencyIndexes: file_proxy_mixed_simplified_config_proto_depIdxs,
		MessageInfos:      file_proxy_mixed_simplified_config_proto_msgTypes,
	}.Build()
	File_proxy_mixed_simplified_config_proto = out.File
	file_proxy_mixed_simplified_config_proto_goTypes = nil
	file_proxy_mixed_simplified_config_proto_depIdxs = nil
}
