...
type CipherTypeWrapper struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Value         shadowsocks.CipherType `protobuf:"varint,1,opt,name=value,proto3,enum=exclave.core.proxy.shadowsocks.CipherType" json:"value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proxy_shadowsocks_simplified_config_proto_rawDesc = "" +
	...
	"\x06method\x18\x03 \x01(\v2<.exclave.core.proxy.shadowsocks.simplified.CipherTypeWrapperR\x06method\x12\x1a\n" +
	...
	"\x03uot\x18\t \x01(\bR\x03uot\x12L\n" +
	"\"experiment_reduced_iv_head_entropy\x18\x91\xbf\x05 \x01(\bR\x1eexperimentReducedIvHeadEntropy:\x1b\x82\xb5\x18\x17\n" +
	"\boutbound\x12\vshadowsocks\"U\n" +
	"\x11CipherTypeWrapper\x12@\n" +
	"\x05value\x18\x01 \x01(\x0e2*.exclave.core.proxy.shadowsocks.CipherTypeR\x05valueB\xbb\x01\n" +
	"Ccom.github.exclavenetwork.exclave.core.proxy.shadowsocks.simplifiedP\x01ZFgithub.com/exclavenetwork/exclave-core/v5/proxy/shadowsocks/simplified\xaa\x02)Exclave.Core.Proxy.Shadowsocks.Simplifiedb\x06proto3"
