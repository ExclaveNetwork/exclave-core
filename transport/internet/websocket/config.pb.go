...
var file_transport_internet_websocket_config_proto_goTypes = []any{
	(*Header)(nil), // 0: exclave.core.transport.internet.websocket.Header
	(*Config)(nil), // 1: exclave.core.transport.internet.websocket.Config
}
var file_transport_internet_websocket_config_proto_depIdxs = []int32{
	0, // 0: exclave.core.transport.internet.websocket.Config.header:type_name -> exclave.core.transport.internet.websocket.Header
