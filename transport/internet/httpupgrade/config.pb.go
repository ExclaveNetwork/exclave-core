...
type Config struct {
	...
	ParseXForwardedFor  bool                   `protobuf:"varint,6,opt,name=parse_x_forwarded_for,json=parseXForwardedFor,proto3" json:"parse_x_forwarded_for,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_transport_internet_httpupgrade_config_proto_rawDesc = "" +
	"\n" +
	"+transport/internet/httpupgrade/config.proto\x123exclave.core.transport.internet.request.httpupgrade\x1a common/protoext/extensions.proto\"0\n" +
	"\x06Header\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xb1\x02\n" +
	"\x06Config\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12$\n" +
	"\x0emax_early_data\x18\x03 \x01(\x05R\fmaxEarlyData\x123\n" +
	"\x16early_data_header_name\x18\x04 \x01(\tR\x13earlyDataHeaderName\x12S\n" +
	"\x06header\x18\x05 \x03(\v2;.exclave.core.transport.internet.request.httpupgrade.HeaderR\x06header\x121\n" +
	"\x15parse_x_forwarded_for\x18\x06 \x01(\bR\x12parseXForwardedFor:\x1c\x82\xb5\x18\x18\n" +
	"\ttransport\x12\vhttpupgradeB\xc1\x01\n" +
	"Ecom.github.exclavenetwork.exclave.core.transport.internet.httpupgradeP\x01ZHgithub.com/exclavenetwork/exclave-core/v5/transport/internet/httpupgrade\xaa\x02+Exclave.Core.Transport.Internet.HttpUpgradeb\x06proto3"
...
var file_transport_internet_httpupgrade_config_proto_goTypes = []any{
	(*Header)(nil), // 0: exclave.core.transport.internet.request.httpupgrade.Header
	(*Config)(nil), // 1: exclave.core.transport.internet.request.httpupgrade.Config
}
var file_transport_internet_httpupgrade_config_proto_depIdxs = []int32{
	0, // 0: exclave.core.transport.internet.request.httpupgrade.Config.header:type_name -> exclave.core.transport.internet.request.httpupgrade.Header
