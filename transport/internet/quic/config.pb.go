...
const file_transport_internet_quic_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/quic/config.proto\x12$exclave.core.transport.internet.quic\x1a\x19google/protobuf/any.proto\x1a\x1dcommon/protocol/headers.proto\x1a common/protoext/extensions.proto\"\xa9\x01\n" +
	"\x06Config\x12\x10\n" +
	...
	"\ttransport\x12\x04quicB\xac\x01\n" +
